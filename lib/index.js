...
var Kubernetesnode = loadModel('./models/kubernetes_node.json');
// var NodeTypeModel = loadModel('./models/node-type.json');
// var NodeModel = loadModel('./models/node.json');

exports.Kubernetesnode = require('./models/kubernetes_node')(Kubernetesnode);
...
module.exports = function (nfvinspector, options) {
    nfvinspector.model(exports.Kubernetesnode);
