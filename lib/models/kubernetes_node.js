...
function Kubernetesnode(Kubernetesnode) {
    ...
    Kubernetesnode.executeCommand = async function (command) {
        ...
        var configuration_model = Kubernetesnode.app.models.configuration;
        
        var kubectl_command = configuration_model.find({where: {'key': { like: 'kubernetes_%' } }, fields: {"key": true, "value": true}}).then(function(kubernetes_information){
    ...
    Kubernetesnode.remoteMethod('executeCommand', {
